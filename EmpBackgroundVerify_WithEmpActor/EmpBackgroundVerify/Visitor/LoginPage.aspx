<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor/HomeMaster.Master" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="EmpBackgroundVerify.Visitor.LoginPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="article">
          ...
          <div class="clr"></div>
          <div class="img"><img src="../images/login.jpg" width="650" height="196" alt="" 
                  class="fl" /></div>
          <div class="post_content">
            ...
            <p >
                <table align="center" 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txtLoginId" ErrorMessage="Cant be blank" Font-Bold="False" 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ControlToValidate="txtPassword" ErrorMessage="Cant be blank" Font-Italic="True" 
                    ...
                    <tr>
                        <td style="width: 346px" align="right">
                            <asp:Button ID="btnLogin" runat="server" BackColor="White" Font-Bold="True" 
                                ForeColor="#33A0CB" Text="LOGIN" Width="300px" onclick="btnLogin_Click" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
