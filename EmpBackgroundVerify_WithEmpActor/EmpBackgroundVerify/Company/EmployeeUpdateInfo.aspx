...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <script type="text/javascript">
       $(document).ready(function () {
           ...
           $('#<%=txtSalaryAssignedDate.ClientID %>').datepicker();
           $('#<%=txtQuitDate.ClientID %>').datepicker();
       });
    ...
    <script src='JScript1%20version%201.9.1.js'></script>
    <script>
                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                    <td style="width: 182px; color: #800000; font-weight: bold;">
                                        Ratings</td>
                                    <td style="width: 259px">
                                        <asp:DropDownList ID="DDLrating" runat="server" ValidationGroup="c">
                    ...
                    <tr>
                        ...
                        <legend style="color:Black;">
                            ...
                            <table style="width:100%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="LB_Left" runat="server" Font-Bold="True" ForeColor="White" 
                                            ...
                                            <table style="width:100%;">
                                                <tr>
                                                    <td style="width: 169px">
                                                        Quit Date</td>
                                                    <td>
                                                        <asp:TextBox ID="txtQuitDate" runat="server" Width="150px" ValidationGroup="d"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtQuitReason" runat="server" Height="106px" Rows="5" 
                                                            TextMode="MultiLine" Width="356px" ValidationGroup="d"></asp:TextBox>
                                                    </td>
                                                    <td valign="top">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                     <asp:DropDownList ID="DDLrating2" runat="server" ValidationGroup="d">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>1</asp:ListItem>
                                            <asp:ListItem>2</asp:ListItem>
                                            <asp:ListItem>3</asp:ListItem>
