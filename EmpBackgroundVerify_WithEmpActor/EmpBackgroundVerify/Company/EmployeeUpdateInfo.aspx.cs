            ...
            if (!this.IsPostBack)
            {
                ...
                if (type == "profile")
                {
                    ...
                    if (type == "designation")
                    {
                        ...
                        ListItem L1=new ListItem(tab_emp.Rows[0]["DeptName"].ToString(),tab_emp.Rows[0]["DeptId"].ToString());
                        ...
                        ListItem L2 = new ListItem(tab_emp.Rows[0]["Designation"].ToString(), tab_emp.Rows[0]["DesId"].ToString());
